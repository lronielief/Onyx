  ...
  widget.innerHTML = `
    <div class="chat-widget__window" id="chatWindow" role="region" aria-label="ONYX VIP Concierge Live Chat">
      ...
      <div class="chat-widget__chips" id="chatChips">
        <button type="button" class="chat-chip" data-query="Reserve a Suite">🛎️ Reserve a Suite</button>
        <button type="button" class="chat-chip" data-query="Dining & Lounges">🍷 Fine Dining</button>
        <button type="button" class="chat-chip" data-query="Gaming Salon Privé">♠️ Gaming Salon</button>
        <button type="button" class="chat-chip" data-query="Responsible Gaming">🛡️ Responsible Play</button>
